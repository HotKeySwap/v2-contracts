...
interface IHotkeyswapRouter02 is IHotkeyswapRouter01 {
...
library SwapLibrary {
    ...
    function pairFor(address factory, address tokenA, address tokenB) internal pure returns (address pair) {
        ...
        pair = address(uint(keccak256(abi.encodePacked(
                ...
                hex'90637a04171364149da3f9092de0cf46dfe10a1359ec68822fc41770fc96b1cf'   // Change to INIT_CODE_PAIR_HASH of Swap Factory
            ))));
    }
...
contract HotkeyswapRouterV2 is IHotkeyswapRouter02 {
    using SafeMath for uint;
    ...
    function _addLiquidity(
        ...
        if (IHotkeyswapFactoryV2(factory).getPair(tokenA, tokenB) == address(0)) {
            IHotkeyswapFactoryV2(factory).createPair(tokenA, tokenB);
        }
        ...
        ensure(deadline)
    {
        ...
        uint amountOut = ITRC20(WETH).balanceOf(address(this));
